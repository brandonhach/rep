		...
		<div className='flex flex-row items-center justify-between px-8 h-14 mt-2 w-screen z-50'>
			...
			<div className='menu menu-horizontal w-fit'>
				{session.status === 'authenticated' ? (
					...
					<>
						<button className='relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 z-50'>
