		...
		<div className="flex items-center justify-center">
			<div className="flex-col max-w-6xl">
				<div className="flex">
					...
					<div>
						<div className="flex rounded-md bg-stone-900 gap-4 p-4">
							<div className="badge rounded-md">default</div>
							<div className="badge badge-neutral rounded-md">Discord</div>
							<div className="badge badge-primary rounded-md">Steam</div>
							<div className="badge badge-secondary rounded-md">Reddit</div>
							<div className="badge badge-accent rounded-md">Twitch</div>
						</div>
						<div className="">
							<h1>{profile.username}'s Bio</h1>
						</div>
					</div>
				</div>
